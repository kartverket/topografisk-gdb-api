...
const LAYER_LABELS: Record<string, string> = {
  ...
  [`${platformEdgesExtrusionLayerId}-solid`]: 'FKB-Bane platform edge',
  [`${platformEdgesExtrusionLayerId}-shadow`]: 'FKB-Bane platform edge',
  [`${trackCentresExtrusionLayerId}-solid`]: 'FKB-Bane track centre',
  [`${trackCentresExtrusionLayerId}-shadow`]: 'FKB-Bane track centre',
  ...
  [platformEdgesLayerId]: 'FKB-Bane platform edge',
  [trackCentresLayerId]: 'FKB-Bane track centre',
