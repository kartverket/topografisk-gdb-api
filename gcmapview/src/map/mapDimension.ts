...
const buildingFlatLayerIds = [
  "building-centroids-circle",
  "buildings-fill",
  "buildings-outline",
] as const;

const buildingExtrusionLayerIds = [
...
function addElevatedLineGroundShadow(
  ...
  baseLayerId: string,
  source: string,
  color: string | ExpressionSpecification = heightColorExpression(
...
export function applyMapLayerVisibility(
  ...
  setLayersVisibility(
    ...
    visibility.buildings && is3d,
  );

  setLayersVisibility(
    map,
    platformEdgesFlatLayerIds,
    visibility.platformEdges && !is3d,
  );
  setLayersVisibility(
    map,
    platformEdges3dLayerIds,
    visibility.platformEdges && is3d,
  );

  setLayersVisibility(
    map,
    trackCentresFlatLayerIds,
    visibility.trackCentres && !is3d,
  );
  setLayersVisibility(
    map,
    trackCentres3dLayerIds,
    visibility.trackCentres && is3d,
  );
}
