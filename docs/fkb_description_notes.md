# FKB descriptions — deferred design notes
...
## 3. `outward_identifier` is always the row UUID

Outward identifier is always assigned UUID. Future updates extend this to other ids
